...
file_name = 'E4_F16_PDP_Final_Section_2'
file_type = '.csv'
...
col_name_rules = {'1' : {'has_decimal' : 'true', 'starting_number' : 3},
                  '2' : {'has_decimal' : 'false', 'starting_number' : 623},
                  '3' : {'has_decimal' : 'false', 'starting_number' : 654},
                  '4' : {'has_decimal' : 'false', 'starting_number' : 685},
                  '5' : {'has_decimal' : 'false', 'starting_number' : 716}}
                ...
                if col_name_rules[str(comment_group_number)]['has_decimal'] == 'true':
                    ...
                    for comment_num in range(max_comments):
                        ...
                        if comment: # Checking if the comment exists
                            (comment_lists[int(presenting_team)]).append((hash_id, commenting_team, comment)) # Breaks because trying to convert a string into integer
